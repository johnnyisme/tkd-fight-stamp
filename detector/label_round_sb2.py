...
啟動:detector/.venv/bin/python detector/label_round.py → http://localhost:8016
"""
import os, json, re
...
IMG_DIR = os.path.join(HERE, "dataset_round_sb2", "images")
LABELS_PATH = os.path.join(HERE, "dataset_round_sb2", "labels.json")
...
if __name__ == "__main__":
    print(f"第一回合標記:http://localhost:8016  ({len(IMAGES)} 個交界)")
